...
const CACHE = 'fishcast-v62';
const SHELL = [
  '/fishcast/',
  '/fishcast/index.html',
  '/fishcast/app.js?v=62',
  '/fishcast/strings.js?v=62',
  '/fishcast/species.js?v=62',
  '/fishcast/style.css?v=62',
  '/fishcast/solunar.js?v=62',
  '/fishcast/spots-dk.js?v=62',
  '/fishcast/regulations-dk.js?v=62',
