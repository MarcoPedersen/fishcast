...
const CACHE = 'fishcast-v64';
const SHELL = [
  '/fishcast/',
  '/fishcast/index.html',
  '/fishcast/app.js?v=64',
  '/fishcast/strings.js?v=64',
  '/fishcast/species.js?v=64',
  '/fishcast/style.css?v=64',
  '/fishcast/solunar.js?v=64',
  '/fishcast/spots-dk.js?v=64',
  '/fishcast/regulations-dk.js?v=64',
