...
export const STRINGS: Record<string, Record<string, string>> = {
  da: {
    ...
    dash_fetching_frozen:'Listen står stille indtil alle data er hentet, så kortene ikke hopper rundt.',
  ...
  en: {
    ...
    dash_fetching_frozen:'The list stays put until every forecast is in, so cards don\'t jump around.',
