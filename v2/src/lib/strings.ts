...
export const STRINGS: Record<string, Record<string, string>> = {
  da: {
    ...
    insight_sub:'Sammenligner modellens score med hvornår du faktisk fangede fisk. {n} kan analyseres (kræver tidspunkt + en gemt lokation).',
    insight_entry_one:'1 registrering', insight_entry_many:'{n} registreringer',
    ...
    avail_time_warn:'Start- og sluttid må ikke være den samme', avail_days_warn:'Vælg mindst én dag',
    avail_fix_before_next:'Ret tidsvinduet ovenfor før du går videre — start og slut må ikke være det samme klokkeslæt.',
    avail_overnight:'Natvindue — slutter næste morgen. Det er helt fint.',
    window_next_day:'Slutter næste dag',
    ...
    relevance_which:'Se hvilke arter', relevance_active_lbl:'Aktive her:', relevance_inactive_lbl:'Ikke aktive nu:',
    log_range_warn:'Tjek tal og dato — antal, længde, vægt skal være realistiske, og datoen kan ikke ligge i fremtiden.',
    sf_sort_by:'Sortér efter', sf_sort_score:'Egnethed', sf_sort_dist:'Afstand',
    sf_shared_rank:'Delt placering — samme score',
    lure_tips_btn:'Agn- og artstips',
    log_score_need_time:'Tilføj et tidspunkt for at få en bid-score for fangsten.',
    log_score_need_loc:'Vælg en af dine gemte lokationer for at få en bid-score.',
    loc_species:'Arter her', loc_species_add:'Vælg arter',
    loc_species_unknown:'Vi kender ikke arterne her — så pladsen scorer lavere end den burde.',
    loc_species_count:'arter valgt',
    loc_species_hint:'Vælg de arter du ved findes her. Sæsonen udfyldes automatisk, og pladsen kan så score på dine målarter.',
    spottype_coast:'kyst', spottype_pier:'mole', spottype_river:'å', spottype_lake:'sø',
    geo_searching:'Søger…', geo_no_results:'Ingen steder fundet — prøv en by eller et postnummer.',
    loc_remove_confirm:'Fjern denne lokation? Dens arter og noter forsvinder også.',
    avail_remove_confirm:'Fjern dette tidsvindue?',
    dash_top_pick_today:'Dagens bedste', dash_top_pick_days:'Bedste de næste',
    relevance_note:'Baseret på officielle pladsdata for denne måned.',
    ...
    setup_import_confirm:'Importér den delte opsætning? Din nuværende opsætning erstattes og kan ikke fortrydes.',
    ...
    auth_local_note:'Denne version kører uden konto: login og synkronisering er ikke tilgængeligt, og alt gemmes kun i denne browser. Rydder du browserdata, er det væk.',
  ...
  en: {
    ...
    insight_sub:'Compares the model\'s score with when you actually caught fish. {n} can be analysed (needs a time + a saved location).',
    insight_entry_one:'1 log entry', insight_entry_many:'{n} log entries',
    ...
    avail_time_warn:'Start and end time must differ', avail_days_warn:'Select at least one day',
    avail_fix_before_next:'Fix the time slot above before continuing — start and end can’t be the same time.',
    avail_overnight:'Overnight window — ends the next morning. That’s fine.',
    window_next_day:'Ends the next day',
    ...
    relevance_which:'See which species', relevance_active_lbl:'Active here:', relevance_inactive_lbl:'Not active now:',
    log_range_warn:'Check the numbers and date — count, length and weight must be realistic, and the date can’t be in the future.',
    sf_sort_by:'Sort by', sf_sort_score:'Suitability', sf_sort_dist:'Distance',
    sf_shared_rank:'Shared rank — same score',
    lure_tips_btn:'Lure and species tips',
    log_score_need_time:'Add a time to get a bite-score for this catch.',
    log_score_need_loc:'Pick one of your saved locations to get a bite-score.',
    loc_species:'Species here', loc_species_add:'Pick species',
    loc_species_unknown:'We don’t know which species are here — so this spot scores lower than it should.',
    loc_species_count:'species selected',
    loc_species_hint:'Pick the species you know are here. The season fills in automatically, so the spot can score against your target species.',
    spottype_coast:'coast', spottype_pier:'pier', spottype_river:'river', spottype_lake:'lake',
    geo_searching:'Searching…', geo_no_results:'No places found — try a town or postcode.',
    loc_remove_confirm:'Remove this location? Its species and notes go too.',
    avail_remove_confirm:'Remove this time slot?',
    dash_top_pick_today:'Best today', dash_top_pick_days:'Best in the next',
    relevance_note:'Based on official spot data for this month.',
    ...
    setup_import_confirm:'Import the shared setup? Your current setup is replaced and this can’t be undone.',
    ...
    auth_local_note:'This build runs without an account: sign-in and sync are unavailable, and everything is stored in this browser only. Clearing browser data loses it.',
